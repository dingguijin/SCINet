...
from experiments.exp_BTC import Exp_BTC
...
### -------  dataset settings --------------
parser.add_argument('--root_path', type=str, default='./datasets/BTC-data/', help='root path of the data file')
parser.add_argument('--input_dimension', type=int, default=79, help='input dimension')
parser.add_argument('--target', type=str, default='pct_close', help='target feature')
parser.add_argument('--checkpoints', type=str, default='exp/BTC_checkpoints/', help='location of model checkpoints')
...
parser.add_argument('--pred_len', type=int, default=15, help='prediction sequence length, horizon')
...
if args.evaluate:
    setting = 'ft{}_sl{}_ll{}_pl{}_lr{}_bs{}_hid{}_s{}_l{}_dp{}_itr0'.format(args.seq_len, args.label_len, args.pred_len,args.lr,args.batch_size,args.hidden_size,args.stacks, args.levels,args.dropout)
    ...
    if args.itr:
        for ii in range(args.itr):
            ...
            setting = 'sl{}_ll{}_pl{}_lr{}_bs{}_hid{}_s{}_l{}_dp{}_itr{}'.format(args.seq_len, args.label_len, args.pred_len,args.lr,args.batch_size,args.hidden_size,args.stacks, args.levels,args.dropout,ii)
        ...
        setting = '{}_sl{}_ll{}_pl{}_lr{}_bs{}_hid{}_s{}_l{}_dp{}_itr0'.format(args.model, args.seq_len, args.label_len, args.pred_len,args.lr,args.batch_size,args.hidden_size,args.stacks, args.levels,args.dropout)
        exp = Exp(args)  # set experiments
        print('>>>>>>>start training : {}>>>>>>>>>>>>>>>>>>>>>>>>>>'.format(setting))
        exp.train(setting)
